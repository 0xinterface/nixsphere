# Generated by Powerlevel10k configuration wizard on 2022-03-27 at 11:59 HKT.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_FIRST_SEGMENT_START_SYMBOL='%K{#3D3D3D} %K{#333333} %K{#292929} %k'
  # The right end of right prompt.
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_LAST_SEGMENT_END_SYMBOL='%K{#292929} %K{#333333} %K{#3D3D3D} %k'
